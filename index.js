...
panel.button('<b>Instructions</b>:<br>* press the change background button<br>* alter the value of the red input box<br>* press the triangle to minimize this panel', null, {style: {textAlign: 'left', background: 'green'}});
